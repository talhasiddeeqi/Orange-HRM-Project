...
```
Error: ENOENT: no such file or directory, stat 'E:\Work\Playwright\Orange HRM Project\utils\attachmentFile.png'
```
...
> 104 |     await this.fileUploadInput.setInputFiles('E:/Work/Playwright/Orange HRM Project/utils/attachmentFile.png');  
      |     ^ Error: ENOENT: no such file or directory, stat 'E:\Work\Playwright\Orange HRM Project\utils\attachmentFile.png'
