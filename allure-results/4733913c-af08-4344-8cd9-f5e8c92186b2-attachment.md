...
```
Error: ENOENT: no such file or directory, stat 'E:\Work\Playwright\Orange HRM Project\attachmentFile.png'
```
...
> 104 |     await this.fileUploadInput.setInputFiles('\attachmentFile.png');  
      |     ^ Error: ENOENT: no such file or directory, stat 'E:\Work\Playwright\Orange HRM Project\attachmentFile.png'
