...
```
Error: locator.click: Error: strict mode violation: locator(':text("Male")') resolved to 2 elements:
    1) <label class="" data-v-7ef819fd="">…</label> aka getByText('Male', { exact: true })
    2) <label class="" data-v-7ef819fd="">…</label> aka getByText('Female')

Call log:
  - waiting for locator(':text("Male")')
...
```ts
  ...
  56  |     this.genderM = page.locator(':text("Male")')
